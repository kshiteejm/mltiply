...
public class SLAQIntraJobScheduler extends IntraJobScheduler {
	...
	public List<Bid> prepareBid(List<GPU> offeredGPUs) {
		...
		double current_loss = getLoss(mTotalExpectedIterations - mTotalIterationsRemaining);
		...
		double predicted_loss = getLoss(mTotalExpectedIterations - mTotalIterationsRemaining
